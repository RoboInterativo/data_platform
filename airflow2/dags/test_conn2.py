...
with DAG('test_connect_dashboard', start_date=days_ago(1), schedule_interval='@daily') as dag:
    ...
    step1 = BashOperator(
                task_id="step1",
                bash_command='airflow connections get dashboard -o json',
            )
